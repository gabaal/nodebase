...
export const EntityHeader = ({
    ...
    return (
        <div className="flex flex-row items-center justify-between gap-x-4">
            ...
            {onNew && !newButtonHref && (
                <Button disabled={isCreating || disabled} size='sm' onClick={onNew}><PlusIcon className="size-4" />{newButtonLabel}</Button>
            )}

            {newButtonHref && !onNew && (
                <Button size='sm' asChild><Link href={newButtonHref} prefetch><PlusIcon className="size-4" />{newButtonLabel}</Link></Button>
            )}
        </div>
    )
}
        ...
        <Link href={href} prefetch>
            <Card
                ...
                <CardContent className="flex flex-row items-center justify-between p-0">
                    ...
                    {(actions || onRemove) && (
                        <div className="flex gap-x-4 items-center">{actions}
                            {onRemove && (
                                <DropdownMenu>
