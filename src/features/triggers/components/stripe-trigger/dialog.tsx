...
export const StripeTriggerDialog = ({ open, onOpenChange }: Props) => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Stripe Event Trigger Configuration</DialogTitle>
                    <DialogDescription>
                        Use this webhook URL in your Stripe dashboard to trigger this workflow when a Stripe event occurs.
                    </DialogDescription>
                </DialogHeader>
