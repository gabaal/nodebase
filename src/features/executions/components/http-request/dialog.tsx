...
export const HttpRequestDialog = ({ open, onOpenChange, defaultEndpoint, defaultMethod = 'GET', defaultBody, onSubmit }: Props) => {
    ...
    const showBodyField = watchMethod && ['POST', 'PUT', 'PATCH'].includes(watchMethod)
